...
namespace Lexer
{
    public class Position
    {
        ...
        {
            // увеличиваем количество колонок после символа, который не равен символам \n и \r (элемент из регулярных выражений.
            // возврат каретки (CR)) - управляющий символ или механизм, используемый для возвращения позиции устройства к началу строки.
            _currentColumn += 1;
        }
